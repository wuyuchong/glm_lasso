...
\textsc{\Large 科研项目}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries glm lasso for R}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\begin{center} \large
\textsc{\large 马景义}\\[0.5cm] % Minor heading such as course title
